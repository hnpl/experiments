...
experiment_tag = "arm64sve-chi-latency-test-spatter"
...
def gem5_params_generator(output_path, command, vlen, num_ccds, enable_prefetcher, num_channels, disk_image_path, hostname):
    ...
    gem5/build/ARM_CHI/gem5.fast configs/gem5/arm64sve.py \
        --command "spatter.hw lanl-spatter/spatter.json" --num_ccds=1 --enable_prefetcher=False --num_channels=2 --vlen=512
    """
...
if __name__ == "__main__":
    ...
    pattern_files = ["/home/ubuntu/lanl-spatter/patterns/flag/static_2d/001.json",
