...
experiment_tag = "arm64sve-latency-test-gups"
gem5_binary_path = "/scr/hn/takekoputa-gem5/build/ARM_MESI_Three_Level/gem5.fast"
gem5_config_path = "/home/hn/experiments/project-1-max-out-bandwith/experiment-8-EPYC-like-correct-latency/configs/gem5/arm64sve.py"
gem5_output_path_prefix = "/home/hn/experiments/project-1-max-out-bandwith/experiment-8-EPYC-like-correct-latency/results/" + experiment_tag + "/"
disk_image_path = "/projects/gem5/hn/DISK_IMAGES/arm64sve-hpc-2204-20230522.img"
...
gem5_binary_md5sum = "fa24a57dc2d2f8474b21958879c35418"
...
def metadata_generator(isa, disk_image_path, command, workload_naming_string, vlen, num_ccds, enable_prefetcher, num_channels):
    ...
    metadata["more-details"] = "Octopi cache, 2-channeled memory, no prefetcher"
...
if __name__ == "__main__":
    ...
    inner_loop_number_of_elements = [128, 512, 1024]
