...
experiment_tag = "arm64sve-simd-mimd-3"
gem5_binary_path = "/home/hn/takekoputa-gem5/build/ARM_MESI_Three_Level/gem5.fast"
gem5_config_path = "/home/hn/experiments/project-1-max-out-bandwith/experiment-7-simd-vs-mimd/configs/gem5/arm64sve-1ccd-2channel-o3-lsq.py"
...
if __name__ == "__main__":
    ...
    for num_cores in [1, 2, 4, 8, 16]:
        ...
        stream_sizes = [2**k for k in range(24, 32)] + [2**k + 2**(k-1) for k in range(24, 31)] # somewhere between 2**27 bytes and 2**31 bytes
