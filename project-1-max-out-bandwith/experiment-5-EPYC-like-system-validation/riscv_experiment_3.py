...
experiment_tag = "riscv-hpc-test-3"
gem5_binary_path = "/scr/hn/takekoputa-gem5/build/RISCV_MESI_Three_Level/gem5.fast"
gem5_config_path = "/home/hn/experiments/project-1-max-out-bandwith/experiment-5-EPYC-like-system-validation/configs/gem5/rv64gc-1ccd-2channel-timing.py"
...
def metadata_generator(isa, disk_image_path, command, workload_naming_string):
    ...
    metadata["more-details"] = "Octopi cache with 1 ccd, 2-channeled memory, timing cpu"
